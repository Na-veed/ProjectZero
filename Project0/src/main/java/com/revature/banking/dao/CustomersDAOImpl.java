...
public class CustomersDAOImpl implements CustomersDAO{
	...
	private String ADD_CUSTOMER_DETAILS="insert into project0.customers values(?,?,?,?,?,?,?)";
	private String MAKE_DEPOSIT="update project0.customers set accountBalance=accountBalance+? where accountNumber=? ";
	private String MAKE_WITHDRAWAL="update project0.customers set accountBalance=accountBalance-? where accountNumber=? ";
	private String VALIDATE_CUSTOMER="select customerUserName,customerPassword from project0.customers where customerUserName=? and customerPassword=? ";
	private String LOAD_ALL_CUSTOMER_DETAILS="select * from project0.customers where customerUserName=?";
