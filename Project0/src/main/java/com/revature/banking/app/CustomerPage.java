...
//		********************************************************************
		...
		while (true) {
			...
			System.out.println();
			System.out.println(
					"                       P L E A S E     E N T E R     Y O U R    C H O I C E                           ");
			System.out.println();
			System.out.println(
					"							    1. V I E W      B A L A N C E                                         ");
			System.out.println();
			System.out.println(
					"								2. D E P O S I T    M O N E Y                                         ");
			System.out.println();
			System.out.println(
					"								3. W I T H D R A W     M O N E Y                                      ");
			System.out.println();
			System.out.println(
					"								4. T R A N S F E R     M O N E Y                                       ");
			System.out.println();
			System.out.println(
					"                                           9.  E X I T                                                  ");
			int choice = 0;
			...
			case 1:
				...
				System.out.println(customers.getCustomerFirstName() + " Your account balance is :"
			...
			case 2:
				...
				if (creditAmount <= 0) {
					...
					logger.fatal("customer entred greater than 50000(can deposit only less than 50000) i.e., "
							+ creditAmount);
					...
					if (customers != null) {
						logger.info("customer deposited " + creditAmount + " successfully and new balance is "
								+ customers.getAccountBalance());
			...
			case 3:
				...
				if (debitAmount <= 0) {
					...
					System.out.println(
							"Sorry, Minimum withdrawal is INR 500, Please withdraw 500 or more, Please try again");
					break;
				} else if (debitAmount > 25000) {
					logger.fatal("customer entred greater than 25000(can withdraw only less than 25000) i.e., "
							+ debitAmount);
					...
					if (customers != null) {
						logger.info("customer withdrawn " + debitAmount + " successfully and new balance is "
								+ customers.getAccountBalance());
						System.out.println("INR " + debitAmount + " withdrawn successfully and your current Balance is "
								+ customers.getAccountBalance());
						break;
					} else {
			...
			case 4:
				...
				if (amount < 0) {
					...
					if (customers != null) {
						logger.info("customer transfered INR  " + amount + " to " + customerAccountNumber
								+ "  successfully and new balance is " + customers.getAccountBalance());
						System.out.println("INR " + amount + " transfered to " + customerAccountNumber
								+ " successfully and yout current Account balance is " + customers.getAccountBalance());
					} else {
						logger.error("transfer failed ");
						System.out.println(
								"Transfer failed, Please enter a valid account Number to transfer...please try again");
					}
					break;
				}
			...
			case 9:
				...
				BankingApp insightApp = new BankingApp();
